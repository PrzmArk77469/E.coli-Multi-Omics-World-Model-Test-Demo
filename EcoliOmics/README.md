...
D:\Python314\python.exe -m ecoli_world.demo_pipeline --observed-map .\integrated\condition_completion\unified_sample_map.tsv.gz --output-dir .\integrated\condition_completion\demo_full --agents 2000 --steps 80 --seed 42 --log-dir ..\Git\logs
```
